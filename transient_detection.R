...
cutoff_index <- get_lc_cutoff( vdp_trial_smooth$replicates[[1]]$smooth)

full_samples <- vdp_trial_smooth$replicates[[1]]$smooth
...
# DEPRICATED FOURIER FUNCTIONS BELOW
# 
# sample_deltaT <- 0.01 # inverse of sampling rate
# vdp_data_noiseless <- list(name = "VDP", system = "van_der_pol", params = list(mu=1.5),
